    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow w-full py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-8 pb-12 rounded-xl shadow-lg max-w-5xl mx-auto mb-16">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div>
                <label htmlFor="name" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
                  Full Name *
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                  placeholder="Enter your full name"
                />
              </div>

              <div>
                <label htmlFor="email" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
                  Email Address *
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="country" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
              ...
              <div>
                <label htmlFor="phone" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
              ...
              <div>
                <label htmlFor="loanSize" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
                  Loan Size Wanted ($) *
                </label>
                <input
                  type="number"
              ...
              <div>
                <label htmlFor="collateral" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
              ...
              <div>
                <label htmlFor="additionalInfo" className="block text-base font-medium text-gray-700 dark:text-gray-200 mb-2">
